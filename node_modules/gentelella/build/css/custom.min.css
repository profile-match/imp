...
.paginate_disabled_previous {
  background: url("../../production/images/back_disabled.png") no-repeat top left
}

.paginate_enabled_previous {
  background: url("../../production/images/back_enabled.png") no-repeat top left
}

.paginate_enabled_previous:hover {
  background: url("../../production/images/back_enabled_hover.png") no-repeat top left
}

.paginate_disabled_next {
  background: url("../../production/images/forward_disabled.png") no-repeat top right
}

.paginate_enabled_next {
  background: url("../../production/images/forward_enabled.png") no-repeat top right
}

.paginate_enabled_next:hover {
  background: url("../../production/images/forward_enabled_hover.png") no-repeat top right
}
...
.loading {
  ...
  bottom: 0;
  left: 0;
  background: #fff url("../../production/images/loading.gif") no-repeat center center;
  opacity: .75;
...
.button {
  background: #f7f9fa;
  background: linear-gradient(to top, #f7f9fa 0%, #f0f0f0 100%);
